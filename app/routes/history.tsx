  ...
  return c.render(
    <MemberLayout title="Riwayat Transaksi" balance={balance}>
      <div class="p-6 md:p-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <tbody class="divide-y divide-gray-200">
                {orders.map((o: any) => (
                  <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">
                      <span class={`px-2 py-1 rounded-full text-[10px] font-bold uppercase ${o.status === 'completed' || o.status === 'success' ? 'bg-green-100 text-green-700' : o.status === 'pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-red-100 text-red-700'}`}>
                        {o.status}
                      </span>
                    </td>
                  </tr>
