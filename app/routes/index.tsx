...
export default createRoute(
  ...
  async (c) => {
    // PROTEKSI: Jangan panggil database user di Landing Page untuk menghindari 
    // masalah 'saldo kosong' dan agar halaman bisa di-cache statis dengan sempurna.
    const userSession = c.get('user')
    const isLoggedIn = !!(userSession && userSession.userId)

    let config = { siteName: 'SMM Panel Pro', primaryColor: '#2563eb' }
    try {
