...
// FIX: isLoggedIn secara default bernilai true agar halaman dalam otomatis menampilkan logout
const Navbar: FC<NavbarProps> = ({ balance = 0, showBalance = true, isLoggedIn = true }) => {
  return (
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex items-center">
            ...
            <a href={isLoggedIn ? "/dashboard" : "/"} class="ml-2 font-bold text-xl tracking-tight text-gray-900 dark:text-white hover:text-blue-600 transition-colors">
              SMMPedia
            </a>
          </div>
          <div class="flex items-center space-x-4">
            
            {/* Saldo hanya muncul jika showBalance true dan user terverifikasi login */}
            ...
            {/* Tampilan tombol dinamis berdasarkan lokasi luar / dalam */}
            {isLoggedIn ? (
